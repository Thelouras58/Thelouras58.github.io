...
This post is part of the study for my diploma thesis, about mild cognitive impairment(MCI) and how can serious games can be used like a non-pharmacological treatment.

## MCI

Cognitive skills are changing over lifetime (Hedden & Gabrieli 2004).
...
Mild cognitive impairment(MSI) represents an intermediate state of cognitive function between changes observed due to aging and those meeting the criteria for dementia and often Alzheimer's disease (Petersen et al., 1999).
